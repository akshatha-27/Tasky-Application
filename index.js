    ...
    <div class="card shadow-sm task__card">
      ...
      <div class="card-footer">
        <button
          ...
          data-bs-target="#showTask" onclick="openTask.apply(this,arguments)" id=${id}
        >Open Task</button>
      </div>
    </div>
  </div>`;
...
// where we convert json to str(i.e local storage)
...
//to save changes when we edit or update
const handleSubmit = (event) => {
  ...
  taskContents.insertAdjacentHTML(
    "beforeend",
    htmlTaskContent({ ...input, id }) //spread operator(...)
  );
